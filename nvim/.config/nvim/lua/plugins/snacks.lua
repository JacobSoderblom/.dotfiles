...
return {
  ...
  keys = {
    ...
    },
    {
      ...
      desc = 'Switch Projects (root dirs)',
    },
    ...
    -- ✨ Word References
    {
      ...
      desc = 'Next Symbol Usage (LSP Words)',
    },
    {
      '[[',
      function()
      ...
      desc = 'Prev Symbol Usage (LSP Words)',
    },
    {
      '<leader>uw',
      function()
  ...
  opts = {
    ...
    scroll = {
      ...
      filter = function(buf)
        ...
        return vim.g.snacks_scroll ~= false and vim.b[buf].snacks_scroll ~= false and vim.bo[buf].buftype ~= 'terminal' and cursor_line > disabled_lines
      end,
    },
